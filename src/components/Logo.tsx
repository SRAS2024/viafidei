...
/**
 * Hand-sketched wooden cross — vertical and horizontal beams rendered
 * with subtle wood-grain striations and irregular pen lines so the mark
 * reads as drawn rather than geometric. Monochrome by default, designed
 * to sit to the left of the "Via Fidei" wordmark in the header.
 */
export function Logo({ size = 44, className }: LogoProps) {
  return (
    ...
    >
      ...
      >
        {/* vertical beam — slightly tapered, hand-drawn outline */}
        <path
        ...
        {/* wood-grain striations — crossbeam */}
