...
/**
 * Circular profile avatar. When editable, a pencil button appears at the
 * bottom right on hover/focus, with a tooltip describing the edit action.
 * Clicking the pencil opens a hidden file input for upload.
 */
