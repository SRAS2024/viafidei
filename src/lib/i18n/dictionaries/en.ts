...
const nav: Dict = {
  ...
  "nav.spiritualGuidance": "Our Lady",
  "nav.liturgyHistory": "Liturgy & History",
  "nav.liturgy": "Liturgy",
  "nav.liturgicalCalendar": "Liturgical Calendar",
  "nav.history": "History",
  "nav.churchDocuments": "Church Documents",
  "nav.saints": "Saints & Our Lady",
  "nav.saintsTab": "Saints",
  "nav.guides": "Guides",
  "nav.group.prayer": "Prayer & Devotion",
  "nav.group.holyPeople": "Saints & Holy People",
  "nav.group.liturgy": "Liturgy & Worship",
  "nav.group.church": "The Church",
  "nav.popes": "Popes",
...
const auth: Dict = {
  ...
  "auth.reset.success": "Your password was reset successfully. You can now log in.",
  "auth.login.passwordReset": "Your password was reset successfully. Please log in.",
  "auth.login.registered": "Your account was created. Please log in to continue.",
  ...
  "auth.success.passwordReset": "Password updated. You can now log in.",
...
const profile: Dict = {
  ...
  "profile.avatar.saving": "Saving photo…",
  "profile.avatar.saved": "Photo saved",
  "profile.avatar.error": "Could not save photo",
  "profile.avatar.unsupported": "Choose a JPG, PNG, or WEBP image",
  "profile.avatar.tooLarge": "Image is too large to save",
  ...
  "profile.goals.startGoal": "Start Goal",
  "profile.goals.alreadyCompleted": "Already Completed",
  ...
  "profile.goals.deleteBody": 'Are you sure? Delete "{name}"? This cannot be undone.',
...
const admin: Dict = {
  ...
  "admin.login.title": "Administrator log-in",
  ...
  "admin.login.userRedirect": "Looking for the member log-in? Go to the standard site.",
  ...
  "admin.card.janitorEdits": "Janitor: edits",
  ...
  "admin.baselineAudit.title": "Baseline content audit",
  "admin.fixtureQuality.title": "Fixture quality diagnostics",
  "admin.productionRunbook.title": "Production growth runbook",
