  ...
  guide({
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Every parish has its own house rules and they save a wedding from a great deal of friction: where photographers may stand and whether flash is allowed; what flowers may be placed and whether they stay for the parish's use; no rice, confetti or petals inside; whether an aisle runner is used; how many musicians and where they sit; the offering for the church, the musician and the servers; and the time the church must be cleared. Give the rules to your vendors in writing, appoint one friend to be the parish's contact on the day, and let the wedding coordinator run the church while you pray. The Nicene Creed is not said at a wedding Mass, so the couple's first prayer together aloud is the Our Father, which is fitting.",
      },
    ],
