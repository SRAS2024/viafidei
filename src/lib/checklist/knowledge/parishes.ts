...
export const parishKnowledge: CuratedEntry[] = [
  ...
  parish(
    ...
    {
      country: "Italy",
      diocese: "Territorial Prelature of Loreto",
      latitude: 43.4406,
      longitude: 13.6103,
      background:
        "The Pontifical Basilica of the Holy House of Loreto enshrines, according to ancient tradition, the house of Nazareth where the Blessed Virgin Mary received the Annunciation. One of the most visited Marian shrines in the world, Loreto is the patronal shrine of aviators.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    ...
    "Padua",
    {
      ...
      longitude: 11.8807,
      background:
        "Known to the people of Padua simply as 'il Santo,' this great basilica holds the tomb and relics of Saint Anthony of Padua. Begun in 1232, the year after his death, it is one of the most important pilgrimage churches in Italy.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    "shrine-of-our-lady-of-czestochowa-jasna-gora",
    "Shrine of Our Lady of Częstochowa (Jasna Góra)",
    "shrine",
    "ul. o. A. Kordeckiego 2",
    "Częstochowa",
    {
      country: "Poland",
      diocese: "Archdiocese of Częstochowa",
      latitude: 50.8121,
      longitude: 19.0967,
      background:
        "The Jasna Góra Monastery enshrines the revered icon of Our Lady of Częstochowa, the Black Madonna, the spiritual heart of Catholic Poland. Mary was proclaimed Queen of Poland here in 1656, and the shrine remains the country's foremost place of pilgrimage.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    "basilica-national-shrine-our-lady-aparecida",
    "Basilica of the National Shrine of Our Lady of Aparecida",
    "minor-basilica",
    "Av. Doutor Júlio Prestes, 921",
    "Aparecida",
    {
      state: "São Paulo",
      country: "Brazil",
      diocese: "Archdiocese of Aparecida",
      latitude: -22.8469,
      longitude: -45.2266,
      background:
        "The largest Marian shrine in the world by capacity, this basilica enshrines the small statue of Our Lady of Aparecida, patroness of Brazil, found by fishermen in 1717. It draws millions of pilgrims each year.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    ...
    "Santiago de Compostela",
    {
      ...
      longitude: -8.5446,
      background:
        "The cathedral enshrines the relics of Saint James the Greater, the Apostle of Spain. The destination of the great medieval pilgrimage route, the Camino de Santiago, it remains one of Christendom's most important pilgrimage sites.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    ...
    "Milan",
    {
      ...
      longitude: 9.1919,
      background:
        "The Cathedral of the Nativity of Saint Mary, seat of the Archbishop of Milan, is one of the largest Gothic cathedrals in the world. Begun in 1386 and completed over centuries, it is the centre of the Ambrosian Rite tradition.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    ...
    "Barcelona",
    {
      ...
      longitude: 2.1744,
      background:
        "Antoni Gaudí's masterwork, the Expiatory Temple of the Holy Family, is a monumental basilica under construction since 1882. Consecrated by Pope Benedict XVI in 2010, it is a celebrated expression of faith in stone.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    ...
    "Sydney",
    {
      ...
      longitude: 151.2134,
      background:
        "The cathedral church of the Archdiocese of Sydney and the seat of its archbishop, St Mary's is the mother church of Australian Catholicism and the longest church in the country, built in the English Gothic Revival style.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    ...
    "Nazareth",
    {
      ...
      longitude: 35.2978,
      background:
        "Built over the traditional site of the home of the Blessed Virgin Mary where the Angel Gabriel announced the Incarnation, this is the largest Christian church in the Middle East and a principal destination of pilgrimage to the Holy Land.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
  parish(
    ...
    "Jerusalem",
    {
      ...
      longitude: 35.2297,
      background:
        "The Church of the Holy Sepulchre encloses Calvary, the place of the Lord's Crucifixion, and the empty tomb of his Resurrection. The holiest site in Christianity, it has been a place of pilgrimage since the fourth century and is shared among several ancient Christian communities.",
      citations: [VATICAN, GCATHOLIC],
    },
  ),
];
