...
const CANON_LAW_SANCTIFYING =
  "https://www.vatican.va/archive/cod-iuris-canonici/eng/documents/cic_lib4-cann834-1253_en.html";
...
export const liturgicalGroupTwo: CuratedEntry[] = [
  ...
  liturgical({
    ...
    citations: [CANON_LAW_SANCTIFYING, USCCB_LITURGICAL_YEAR, GIRM],
  }),
  liturgical({
    ...
    citations: [CANON_LAW_SANCTIFYING, USCCB_LITURGICAL_YEAR],
  }),
  liturgical({
    ...
    citations: [LUMEN_GENTIUM, CANON_LAW_SANCTIFYING, GIRM],
  }),
  liturgical({
    ...
    citations: [CANON_LAW_SANCTIFYING, SACROSANCTUM_CONCILIUM],
  }),
  liturgical({
  ...
  liturgical({
    ...
    citations: [CANON_LAW_SANCTIFYING, USCCB_CALENDAR, USCCB_LITURGICAL_YEAR],
  }),
  liturgical({
