...
_SELFTEST_CASES: Dict[str, Dict[str, Any]] = {
    ...
    "classify_entity": {"title": "Rerum Novarum encyclical", "contentType": "CHURCH_DOCUMENT"},
    "link_entity_to_ontology": {"entity_type": "POPE"},
    "validate_entity_relationship": {"subject_type": "POPE", "relation": "authored", "object_type": "ENCYCLICAL"},
    "detect_ontology_gap": {"present_types": ["POPE", "ENCYCLICAL", "WIDGET"]},
    "explain_ontology_decision": {"subject_type": "SAINT", "relation": "is_a", "object_type": "DOCTOR_OF_THE_CHURCH"},
    "infer_ontology_relationships": {"entity_type": "POPE"},
    # Strategy tournament
    "generate_candidate_strategies": {},
    "simulate_strategy": {"name": "vatican_documents_first"},
    "run_strategy_tournament": {},
    "rank_strategy": {},
    "explain_winning_strategy": {},
    "store_strategy_result": {"winner": "catechism_first", "score": 0.8},
    # Benchmark arena + brain-version comparison
    "run_intelligence_benchmark": {"results": {"detect_exact_duplicate": 0.9, "diagnose_pdf_failure": 0.4}},
    "rank_weakest_skills": {"results": {"detect_exact_duplicate": 0.9, "diagnose_pdf_failure": 0.4}},
    "score_brain_version": {"version": "v18", "metrics": {"benchmark_score": 0.8, "publish_safety": 0.95}},
    "compare_brain_versions": {"version_a": {"version": "v17", "metrics": {"benchmark_score": 0.7}}, "version_b": {"version": "v18", "metrics": {"benchmark_score": 0.82}}},
    "detect_intelligence_regression": {"baseline": {"detect_exact_duplicate": 0.9}, "candidate": {"detect_exact_duplicate": 0.6}},
    "detect_brain_regression": {"version_a": {"version": "v17", "metrics": {"benchmark_score": 0.8}}, "version_b": {"version": "v18", "metrics": {"benchmark_score": 0.7}}},
    "explain_brain_improvement": {"version_a": {"version": "v17", "metrics": {"benchmark_score": 0.7}}, "version_b": {"version": "v18", "metrics": {"benchmark_score": 0.82}}},
    "recommend_brain_upgrade": {"version_a": {"version": "v17", "metrics": {"benchmark_score": 0.7}}, "version_b": {"version": "v18", "metrics": {"benchmark_score": 0.82}}},
    "publish_benchmark_report": {"results": {"detect_exact_duplicate": 0.9}},
    # Digital twin
    "create_worker_simulation": {"scenarios": ["pdf_extraction_failure", "duplicate_content"]},
    "replay_worker_history": {"history": [{"scenario": "source_fetch_success", "outcome": "advanced"}]},
    "simulate_database_state": {"state": {"published": 100, "pending": 10}},
    "simulate_source_failure": {"kind": "pdf_extraction_failure"},
    "simulate_publish_pipeline": {"artifact": {"complete": True, "sensitive": False}},
    "simulate_admin_feedback": {"feedback": "correction"},
    "compare_simulated_vs_real_outcome": {"simulated": "published", "real": "published"},
    # Capability invention
    "invent_capability": {"name": "three_path_pdf_extraction"},
    "decompose_capability": {"name": "three_path_pdf_extraction"},
    "estimate_capability_gain": {"name": "three_path_pdf_extraction"},
    "design_capability_contract": {"name": "vatican_metadata_extractor"},
    "design_capability_tests": {"name": "vatican_metadata_extractor"},
    "rank_new_capabilities": {},
    "explain_capability_need": {"name": "three_path_pdf_extraction"},
    # Curriculum
    "generate_training_cases": {"skill": "duplicate_detection"},
    "rank_training_difficulty": {"cases": [{"skill": "duplicate_detection", "level": "exact", "difficulty": 0.2}, {"skill": "duplicate_detection", "level": "translated_variant", "difficulty": 0.8}]},
    "run_curriculum": {"results": {"duplicate_detection:exact": 1.0, "duplicate_detection:fuzzy": 0.6}},
